...
public class ExcelService implements IExcelService {
    ...
    @Override
    public ByteArrayInputStream exportProject(int idProyecto) throws Exception {
        ...
        List<VentaDTO> ventasDTO = ventaService.listarVentas(idProyecto);
        int initRow=1;
        ...
        List<ProductoDTO> productosDTO = productoService.listarProductos(idProyecto);
        int productoInit=1;
        ...
        List<InsumoDTO> insumosDTO = insumoService.listarInsumos(idProyecto);
        int insumoInit=1;
